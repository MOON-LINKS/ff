...
class CustomSubcategoryEditor extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CustomSubcategoryEditor> createState() =>
      _CustomSubcategoryEditorState();
}

class _CustomSubcategoryEditorState
    extends ConsumerState<CustomSubcategoryEditor> {
                  ...
                  CustomMenuButton(
                    onPressed: () {
                      ...
                      final uuid = widget.subcategory?['uuid'] ??
                          'sub-${const Uuid().v4()}';
                      ref.read(menuProvider.notifier).addOrModifySubcategory(
                          uuid, widget.categoryUuid, title);
