...
import 'package:moonlinks/menu/elements/features/country_branch/branch_editor.dart';
import 'package:moonlinks/menu/elements/features/country_branch/country_editor.dart';
...
class CountryBranchEnabled extends ConsumerStatefulWidget {
  const CountryBranchEnabled({super.key});

  @override
  ConsumerState<CountryBranchEnabled> createState() =>
      _CountryBranchEnabledState();
}

class _CountryBranchEnabledState extends ConsumerState<CountryBranchEnabled> {
  bool countryEditorOpen = false;
  void saveCountry(String newCountry) {
    final countryBranch = ref.read(menuProvider)['payload']['country-branch'];
  ...
  Widget build(BuildContext context) {
    ...
    bool enabled = menuState['payload']['country-branch']['enabled'];
    List<dynamic> countries =
        menuState['payload']['country-branch']['countries'] ?? [];
    return Column(
          ...
          children: [
            CustomMenuCheckbox(
                ...
                onChanged: (val) {
                  ...
                  menuNotifier.addOrUpdateInfo('country-branch',
