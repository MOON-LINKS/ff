...
import 'package:moonlinks/menu/elements/features/social_media/social_media_editor.dart';
...
class SocialMediaEnabled extends ConsumerStatefulWidget {
  const SocialMediaEnabled({super.key});

  @override
  ConsumerState<SocialMediaEnabled> createState() => _SocialMediaEnabledState();
}

class _SocialMediaEnabledState extends ConsumerState<SocialMediaEnabled> {
  bool editorOpen = false;

  void deleteLink(int index) {
    final mediaState = ref.read(menuProvider)['payload']['social_media'];
  ...
  Widget build(BuildContext context) {
    final mediaNumber = ref.watch(menuProvider)['features']['social_media'];
    final mediaState = ref.watch(menuProvider)['payload']['social_media'];
