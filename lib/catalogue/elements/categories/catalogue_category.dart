...
import 'package:moonlinks/catalogue/pages/catalogue_subcategories.dart';
...
class CatalogueCategory extends ConsumerStatefulWidget {
  final String title;
  final String? icon;
  ...
  @override
  ConsumerState<CatalogueCategory> createState() => _CatalogueCategoryState();
}

class _CatalogueCategoryState extends ConsumerState<CatalogueCategory> {
  @override
        ...
        CustomMenuButton(
            onPressed: () {
              ...
              Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => CatalogueSubcategories(
                      catUuid: uuid,
                    ),
                  ));
            },
