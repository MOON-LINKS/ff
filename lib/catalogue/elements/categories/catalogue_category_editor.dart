...
class CatalogueCategoryEditor extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CatalogueCategoryEditor> createState() =>
      _CatalogueCategoryEditorState();
}

class _CatalogueCategoryEditorState
    extends ConsumerState<CatalogueCategoryEditor> {
  ...
  void initState() {
    ...
    imageUrl = (widget.category != null && widget.hasInventoryFeature == 1)
        ...
        : null;
    displayOrder =
        widget.category != null ? (widget.category!['display_order'] ?? 0) : 0;
  }
  ...
  Future<void> _pickImage() async {
    final picked = await catalogueCustomPickImage(context, 1);
    setState(() {
      isLoading = true;
    });
    setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    final menuState = ref.watch(catalogueProvider);
              ...
              children: [
                ...
                CustomMenuButton(
                  onPressed: () {
                    ...
                    ref.read(catalogueProvider.notifier).addOrModifyCategory(
                          uuid,
                          title,
                          iconKey,
                          imageUrl,
