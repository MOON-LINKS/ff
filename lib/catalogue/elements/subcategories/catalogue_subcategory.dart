...
class CatalogueSubcategory extends ConsumerStatefulWidget {
  final String title;
  ...
  @override
  ConsumerState<CatalogueSubcategory> createState() =>
      _CatalogueSubcategoryState();
}

class _CatalogueSubcategoryState extends ConsumerState<CatalogueSubcategory> {
  @override
