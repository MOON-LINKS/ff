...
import 'package:moonlinks/catalogue/elements/catalogue_add_on_calculator.dart';
import 'package:moonlinks/l10n/app_localizations.dart';

class CatalogueAddOns extends StatefulWidget {
  const CatalogueAddOns({super.key});

  @override
  State<CatalogueAddOns> createState() => _CatalogueAddOnsState();
}

class _CatalogueAddOnsState extends State<CatalogueAddOns> {
  bool isOpen = true;
  ...
  void initializeAddOn() async {
    try {
      final response = await catalogueAPI.getAddOns();
      setState(() {
        addOn = response['data'];
      });
    } catch (e) {
