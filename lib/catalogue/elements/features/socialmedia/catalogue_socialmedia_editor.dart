...
class CatalogueSocialMediaEditor extends ConsumerStatefulWidget {
  final VoidCallback closeEditor;
  const CatalogueSocialMediaEditor({super.key, required this.closeEditor});

  @override
  ConsumerState<CatalogueSocialMediaEditor> createState() =>
      _CatalogueSocialMediaEditorState();
}

class _CatalogueSocialMediaEditorState
    extends ConsumerState<CatalogueSocialMediaEditor> {
  String? icon;
  List<String> icons = [];
  ...
  void initState() {
    super.initState();
    icons = List<String>.from(ref.read(catalogueProvider)['assets']['media']);
  }
  ...
  void saveMedia() {
    final media = ref.read(catalogueProvider)['payload']['social_media'];
