...
class CatalogueSocialMediaNotEnabled extends StatefulWidget {
  const CatalogueSocialMediaNotEnabled({super.key});

  @override
  State<CatalogueSocialMediaNotEnabled> createState() =>
      _CatalogueSocialMediaNotEnabledState();
}

class _CatalogueSocialMediaNotEnabledState
    extends State<CatalogueSocialMediaNotEnabled> {
  @override
