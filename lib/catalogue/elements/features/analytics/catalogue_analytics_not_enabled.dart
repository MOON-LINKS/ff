...
class CatalogueAnalyticsNotEnabled extends StatefulWidget {
  const CatalogueAnalyticsNotEnabled({super.key});

  @override
  State<CatalogueAnalyticsNotEnabled> createState() =>
      _CatalogueAnalyticsNotEnabledState();
}

class _CatalogueAnalyticsNotEnabledState
    extends State<CatalogueAnalyticsNotEnabled> {
  @override
