...
class CatalogueCountryBranchNotEnabled extends StatefulWidget {
  const CatalogueCountryBranchNotEnabled({super.key});

  @override
  State<CatalogueCountryBranchNotEnabled> createState() =>
      _CatalogueCountryBranchNotEnabledState();
}

class _CatalogueCountryBranchNotEnabledState
    extends State<CatalogueCountryBranchNotEnabled> {
