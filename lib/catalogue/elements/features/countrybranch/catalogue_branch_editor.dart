...
class CatalogueBranchEditor extends StatefulWidget {
  final bool isOpen;
  final int countryId;
  final Function(int, String, String, dynamic) save;
  final VoidCallback closeWidget;
  const CatalogueBranchEditor(
      {super.key,
  ...
  @override
  State<CatalogueBranchEditor> createState() => _CatalogueBranchEditorState();
}

class _CatalogueBranchEditorState extends State<CatalogueBranchEditor> {
