...
class CatalogueOpencloseNotEnabled extends StatefulWidget {
  const CatalogueOpencloseNotEnabled({super.key});

  @override
  State<CatalogueOpencloseNotEnabled> createState() =>
      _CatalogueOpencloseNotEnabledState();
}

class _CatalogueOpencloseNotEnabledState
    extends State<CatalogueOpencloseNotEnabled> {
  final hours = [
    {
      'day': 'Monday',
      'from': null,
